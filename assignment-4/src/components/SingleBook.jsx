...
import { deleteBook } from "../redux/book/bookThunk";

const SingleBook = ({ book, setCurrentButtonStatus, setFormState }) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-gray-500 space-x-2">
            <button
              className="lws-edit"
              onClick={() => {
                setCurrentButtonStatus("updateBook");
                setFormState({
                  name,
                  author,
                  thumbnail,
            ...
            <button
              ...
              onClick={() => removeBook(id.toString())}
            >
              <svg
                fill="none"
                viewBox="0 0 24 24"
